...
void Sandbox2D::onUpdate(RendererEngine::Timestep ts){
	...
	
	{
		...
		RendererEngine::Renderer2D::drawQuad({-5.0f, -5.0f, -0.1f}, {10.0f, 10.0f}, _checkerboardTexture, 10.0f); // checkerboard texture shape
		/* RendererEngine::Renderer2D::drawQuad({-5.0f, -0.5f, -0.1f}, {10.0f, 10.0f}, _checkerboardTexture, 20.0f); // checkerboard texture shape */
